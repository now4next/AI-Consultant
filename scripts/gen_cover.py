...
def motif_source(accent="#d9c48f"):
    """A feeling (wave) traced back along a dashed line to where it came from (a ripple's origin)."""
    return f'''<svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <g fill="none" stroke="{accent}" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="28" cy="34" r="11" stroke-width="1.6" opacity=".55"/>
        <circle cx="28" cy="34" r="18" stroke-width="1.2" opacity=".28"/>
        <path d="M40 82 C46 70 52 70 58 82 C64 94 70 94 76 82 C82 70 88 70 94 82 C98 90 102 92 106 88" stroke-width="2.6"/>
        <path d="M40 82 L32 50" stroke-width="1.6" stroke-dasharray="3 5" opacity=".7"/>
        <path d="M28.6 53.4 L31.2 45.8 L36.2 52" stroke-width="1.6" opacity=".7"/>
      </g>
      <circle cx="28" cy="34" r="4.5" fill="{accent}"/>
    </svg>'''
...
def motif_strata(accent="#d9c48f"):
    ...
    return f'''<svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <g fill="none" stroke="{accent}" stroke-linecap="round">
        <g opacity=".33" stroke-width="1.5">
          <line x1="14" y1="38" x2="106" y2="38"/>
          <line x1="14" y1="52" x2="106" y2="52"/>
          <line x1="14" y1="66" x2="106" y2="66"/>
          <line x1="14" y1="80" x2="106" y2="80"/>
          <line x1="14" y1="94" x2="106" y2="94"/>
        </g>
        <g opacity=".5" stroke-width="1.6">
          <line x1="24" y1="26" x2="24" y2="38"/>
          <line x1="31" y1="26" x2="31" y2="38"/>
          <line x1="38" y1="26" x2="38" y2="38"/>
          <line x1="45" y1="26" x2="45" y2="38"/>
          <line x1="52" y1="26" x2="52" y2="38"/>
        </g>
        <line x1="82" y1="24" x2="82" y2="92" stroke-width="2.6"/>
        <path d="M77 86 L82 93 L87 86" stroke-width="2.2" stroke-linejoin="round"/>
      </g>
      <g fill="{accent}" stroke="none">
        <circle cx="82" cy="38" r="2.4"/><circle cx="82" cy="52" r="2.4"/>
        <circle cx="82" cy="66" r="2.4"/><circle cx="82" cy="80" r="2.4"/>
      </g>
    </svg>'''
...
def motif_shadow(accent="#d9c48f"):
    ...
    return f'''<svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <line x1="8" y1="102" x2="112" y2="102" stroke="{accent}" stroke-width="1.6" opacity=".35"/>
      <g fill="none" stroke="{accent}" stroke-linecap="round" stroke-linejoin="round">
        <g stroke-dasharray="4 5" opacity=".42" stroke-width="1.8">
          <rect x="46" y="44" width="46" height="44" rx="6"/>
          <line x1="46" y1="56" x2="92" y2="56"/>
          <line x1="56" y1="68" x2="82" y2="68"/>
          <line x1="56" y1="78" x2="74" y2="78"/>
        </g>
        <rect x="24" y="28" width="46" height="44" rx="6" stroke-width="2.3"/>
        <line x1="24" y1="40" x2="70" y2="40" stroke-width="2.1"/>
        <circle cx="31" cy="34" r="1.7" fill="{accent}" stroke="none"/>
        <circle cx="38" cy="34" r="1.7" fill="{accent}" stroke="none"/>
        <line x1="34" y1="52" x2="60" y2="52" stroke-width="1.7" opacity=".8"/>
        <line x1="34" y1="62" x2="52" y2="62" stroke-width="1.7" opacity=".8"/>
        <g stroke-dasharray="3 5" opacity=".55" stroke-width="1.6">
          <path d="M94 66 L110 66"/>
        </g>
        <path d="M106 62 L110.5 66 L106 70" stroke-width="1.6" opacity=".55"/>
      </g>
    </svg>'''


def motif_scatter(accent="#d9c48f"):
    """A target whose hits are spread wide: noise, not bias."""
    return f'''<svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <line x1="8" y1="104" x2="112" y2="104" stroke="{accent}" stroke-width="1.6" opacity=".35"/>
      <g fill="none" stroke="{accent}" stroke-linecap="round">
        <circle cx="58" cy="56" r="34" stroke-width="1.4" opacity=".35"/>
        <circle cx="58" cy="56" r="21" stroke-width="1.4" opacity=".5"/>
        <circle cx="58" cy="56" r="8" stroke-width="1.8" opacity=".8"/>
        <line x1="58" y1="14" x2="58" y2="24" stroke-width="1.3" opacity=".4"/>
        <line x1="58" y1="88" x2="58" y2="98" stroke-width="1.3" opacity=".4"/>
        <line x1="16" y1="56" x2="26" y2="56" stroke-width="1.3" opacity=".4"/>
        <line x1="90" y1="56" x2="100" y2="56" stroke-width="1.3" opacity=".4"/>
        <g stroke-width="2.1">
          <path d="M34 34 L42 42 M42 34 L34 42"/>
          <path d="M74 30 L82 38 M82 30 L74 38"/>
          <path d="M28 70 L36 78 M36 70 L28 78"/>
          <path d="M80 66 L88 74 M88 66 L80 74"/>
          <path d="M54 80 L62 88 M62 80 L54 88"/>
        </g>
      </g>
    </svg>'''


def motif_offload(accent="#d9c48f"):
    """A dense network on one side, thinning into dashed outlines on the other."""
    return f'''<svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <line x1="8" y1="100" x2="112" y2="100" stroke="{accent}" stroke-width="1.6" opacity=".35"/>
      <g fill="none" stroke="{accent}" stroke-linecap="round" stroke-linejoin="round">
        <path d="M22 44 L42 30 M22 44 L36 62 M42 30 L36 62 M36 62 L24 80 M42 30 L56 48 M36 62 L56 48 M24 80 L36 62" stroke-width="1.7"/>
        <g stroke-dasharray="3 6" opacity=".4" stroke-width="1.4">
          <path d="M80 36 L98 50 M80 36 L84 64 M98 50 L84 64 M84 64 L98 82"/>
        </g>
        <path d="M58 50 C66 52 70 54 75 58" stroke-width="1.6" opacity=".7"/>
        <path d="M75 58 L68.5 57.5 M75 58 L72.5 52" stroke-width="1.6" opacity=".7"/>
      </g>
      <g fill="{accent}" stroke="none">
        <circle cx="22" cy="44" r="2.6"/><circle cx="42" cy="30" r="2.6"/><circle cx="36" cy="62" r="2.6"/>
        <circle cx="24" cy="80" r="2.6"/><circle cx="56" cy="48" r="2.6"/>
      </g>
      <g fill="none" stroke="{accent}" stroke-width="1.3" opacity=".45">
        <circle cx="80" cy="36" r="2.6"/><circle cx="98" cy="50" r="2.6"/><circle cx="84" cy="64" r="2.6"/><circle cx="98" cy="82" r="2.6"/>
      </g>
    </svg>'''

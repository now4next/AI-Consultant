...
CAT_CSS = """
  /* cat:start */
  :root{--c-strategy:#2b6cb0;--c-people:#c2410c;--c-judgment:#6b21a8;--c-duty:#b45309;--c-growth:#15803d;--c-reflect:#0e7490;--c-history:#7c2d12;--c-culture:#9d174d;--c-eval:#4338ca}
  @media (prefers-color-scheme: dark){:root{--c-strategy:#7fb3ff;--c-people:#ffa27a;--c-judgment:#c9a0ff;--c-duty:#f6bd5c;--c-growth:#5ce08c;--c-reflect:#5ccdf5;--c-history:#dca877;--c-culture:#ff9ec4;--c-eval:#a5b4fc}}
  .hero[data-cat="전략"]{--cc:var(--c-strategy)} .hero[data-cat="사람"]{--cc:var(--c-people)} .hero[data-cat="판단"]{--cc:var(--c-judgment)}
  .hero[data-cat="책임"]{--cc:var(--c-duty)} .hero[data-cat="성장"]{--cc:var(--c-growth)} .hero[data-cat="성찰"]{--cc:var(--c-reflect)} .hero[data-cat="역사"]{--cc:var(--c-history)} .hero[data-cat="문화"]{--cc:var(--c-culture)} .hero[data-cat="평가"]{--cc:var(--c-eval)}
